...
class SyllabusTracker(Base):
    """Global pre-populated curriculum (personal bot → one shared roadmap); one row per sub-topic."""  # noqa: E501

    __tablename__ = "syllabus_tracker"
    __table_args__ = (
        UniqueConstraint("month", "week", "sub_topic", name="uq_syllabus_row"),
